...
class TitleIntroduction extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div className="title-introduction" ref='titleStep'>

        <strong className="title-introduction__dive">

          <span ref="titleDive">First Dive</span>

        </strong>

        <span className="title-introduction__separator" ref="titleSep"></span>

        <h1 className="title-introduction__name" ref="titleName">{title}</h1>
